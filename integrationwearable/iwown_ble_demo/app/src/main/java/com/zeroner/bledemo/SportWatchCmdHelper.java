...
public class SportWatchCmdHelper {
    ...
    public static void getSomeBaseInfo(Context context){
        ...
        byte[] firmwareProductTime = MtkSendBluetoothCmdImpl.getInstance(context).getFirmwareProductTime();
        BackgroundThreadManager.getInstance().addWriteData(context, firmwareProductTime);
