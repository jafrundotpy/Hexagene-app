...
public class SportWatchFirmwareUpgradeActivity extends AppCompatActivity {
    ...
    private void startUpGrade() {
        ...
        if (!BluetoothUtil.isConnected()) {
            ...
            File fir = new File(SuperBleSDK.getInstance().getContext().getExternalFilesDir(null).getAbsolutePath()+getString(R.string.firmware_up_dir)+"F1_Firmware_1.1.0.8.bin");
