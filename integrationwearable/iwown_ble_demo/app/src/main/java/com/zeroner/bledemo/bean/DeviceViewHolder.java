...
import com.zeroner.bledemo.setting.ProtoBufSettingActivity;
...
public class DeviceViewHolder extends BaseViewHolder<DummyItem> {
    ...
    public void onItemViewClick(DummyItem data) {
        ...
        if(BluetoothUtil.isConnected() && SuperBleSDK.isIown(context)){
            ...
            UI.startActivity((Activity) context, ProtoBufSettingActivity.class);
        } else if (BluetoothUtil.isConnected() && SuperBleSDK.isJL(context)) {
            UI.startActivity((Activity) context, ProtoBufSettingActivity.class);
        }
    }
}
