...
public class DialViewHolder extends BaseViewHolder<R1Data> {
    public  TextView mTitle;
    private Context context;
    public DialViewHolder(ViewGroup parent, Context context) {
    ...
    public void onItemViewClick(R1Data data) {
        ...
        if(BluetoothUtil.isConnected()) {
            UI.startActivity((Activity) context, DialDemoActivity.class);
        }
    }
}
