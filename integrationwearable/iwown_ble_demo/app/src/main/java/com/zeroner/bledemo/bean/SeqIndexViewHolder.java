...
import com.zeroner.bledemo.seq_index.SeqIndexDemoActivity;
...
public class SeqIndexViewHolder extends BaseViewHolder<YylpfeData> {
    public  TextView mTitle;
    private Context context;
    public SeqIndexViewHolder(ViewGroup parent, Context context) {
    ...
    public void onItemViewClick(YylpfeData data) {
        ...
        UI.startActivity((Activity) context, SeqIndexDemoActivity.class);
    }
}
