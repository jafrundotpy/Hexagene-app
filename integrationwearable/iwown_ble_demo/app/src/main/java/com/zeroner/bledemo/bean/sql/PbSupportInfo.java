...
public class PbSupportInfo extends DataSupport {
    ...
    private boolean support_yylpfe;
    ...
    public boolean isSupport_yylpfe() {
        return support_yylpfe;
    }

    public void setSupport_yylpfe(boolean support_yylpfe) {
        this.support_yylpfe = support_yylpfe;
    }
}
