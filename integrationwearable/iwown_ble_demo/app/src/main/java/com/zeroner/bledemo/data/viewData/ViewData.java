...
public class ViewData {
    ...
    public static List<DummyItem> getDeviceData(Context context) {
        ...
        DummyItem item = new DummyItem(context.getString(R.string.title_device_list)
                ...
                String.format(context.getString(R.string.index_device_sn), sn));
        items.add(item);
        return items;
    }
    ...
    public static List<R1Data> getDialData(Context context) {
        List<R1Data> items = new ArrayList<>();
        R1Data r1Data = new R1Data(context.getString(R.string.dial_title));
        items.add(r1Data);
        return items;
    }

    public static List<YylpfeData> getYYLpfeData(Context context) {
        List<YylpfeData> items = new ArrayList<>();
        YylpfeData r1Data = new YylpfeData(context.getString(R.string.yylpfe_title));
        items.add(r1Data);
        return items;
    }

    public static List<YylpfeData> getSeqIndex(Context context) {
        List<YylpfeData> items = new ArrayList<>();
        YylpfeData r1Data = new YylpfeData("同步的数据Index");
        items.add(r1Data);
        return items;
    }
