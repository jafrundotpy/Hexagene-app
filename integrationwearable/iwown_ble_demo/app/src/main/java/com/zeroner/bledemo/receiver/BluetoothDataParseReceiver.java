...
import com.zeroner.bledemo.data.JLDataParsePresenter;
...
//                BaseActionUtils.showToast(R.string.connect_error_257);
    ...
    public void connectStatue(boolean isConnect) {
        ...
        if (wristBand != null) {
            ProtoBufDataParsePersenter.setDataFrom(wristBand.getName());
    ...
    public void onDataArrived(Context context, int ble_sdk_type, int dataType, String data) {
        ...
        switch (ble_sdk_type) {
            ...
            case ProtoBufDataParsePersenter.Type2:
                ...
                break;
            case JLDataParsePresenter.Type:
                JLDataParsePresenter.parseProtocolData(context, dataType, data);
                break;
            default:
                break;
        }
