...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private void findByIdView() {
         ...
         toolbarDevice = findViewById(R.id.toolbar_device);
    }
    ...
    static class ViewHolder extends ComViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            image2DeviceIcon = view.findViewById(R.id.image_2_device_icon);
            itemDeviceType = view.findViewById(R.id.item_device_type);
