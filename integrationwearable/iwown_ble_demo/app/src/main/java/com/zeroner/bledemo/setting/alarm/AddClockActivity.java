...
public class AddClockActivity extends BaseActivity {
    ...
    private void findByIdView() {
        ...
        findViewById(R.id.delete_clock_btn).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //来电推送
        findViewById(R.id.testCall).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                byte[] callData = ProtoBufSendBluetoothCmdImpl.getInstance()
                        .setMsgNotificationNotifyByCall(1, 0, true, true, true, "Call", "18888886666");
                BackgroundThreadManager.getInstance().addWriteData(getApplicationContext(), callData);
            }
        });
        //挂断电话
        findViewById(R.id.testEndCall).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                byte[] endCall = ProtoBufSendBluetoothCmdImpl.getInstance()
                        .setMsgNotificationNotifyByCall(1, 1, true, true, true,
                                "Call", "18888886666");
                BackgroundThreadManager.getInstance().addWriteData(getApplicationContext(), endCall);
            }
        });
