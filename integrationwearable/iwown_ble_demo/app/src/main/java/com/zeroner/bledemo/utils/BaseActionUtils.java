...
public class BaseActionUtils {
    ...
    public final static String Action_device_FotaType = "com.zeroner.app.Action_device_FotaType";
    ...
    //5515固件升级地址
    public final static String Action_firmware_address = "com.zeroner.app.Action_firmware_address";
    //5515资源升级地址
    public final static String Action_res_address = "com.zeroner.app.Action_res_address";
