...
public class OptionsPickerViewUtils {
    ...
    public static List<String> getAqi(Context context){
        String[] timeItems = context.getResources().getStringArray(R.array.aqi_name);
        return  Arrays.asList(timeItems);
    }

    public static int[] getAqiIndex(Context context){
        int[] timeItems = context.getResources().getIntArray(R.array.aqi);
        return  timeItems;
    }
    ...
    public static List<String> getWeather(Context context){
        String[] timeItems = context.getResources().getStringArray(R.array.weather);
        return  Arrays.asList(timeItems);
    }
